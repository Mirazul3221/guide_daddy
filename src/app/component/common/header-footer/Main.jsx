...
const Main = () => {
  return (
    ...
    <div class="hidden md:block main bg-[url('/images/home/head-banner.webp')] bg-center bg-cover py-10 pb-40">
      <div class="w-fit mb-14 m-auto">
        <h2 class="text-center mt-6 text-white text-3xl">Your Trip Starts Here</h2>
        <div class="flex gap-10 mt-12 text-white">
          ...
          <div class="flex gap-2">
            ...
            <h3 class="border-b-[1px] border-dotted">Support in Approx. 30s</h3>
          </div>
        </div>
      </div>
      ...
      <div class="search_box relative mt-6 mx-20 m-auto rounded-lg p-6 bg-white">
        <div
          class="tab_bar absolute text-white -top-6 w-9/12 px-4 py-2 left-[50%] flex justify-between items-center translate-x-[-50%] rounded-full bg-gray-900">
        ...
        <div class="card_body mt-6 flex">
          <div class="item border-[1px] px-4 py-2 w-full">
            <p class="text-gray-400 text-[12px]">Destination</p>
              <input class="outline-none pl-2" placeholder="City ,airpot, region, landmark, or property name" type="text"/>
          </div>
    ...
    <div class="body_box md:p-10 bg-white rounded-[35px] -mt-20">
      <div class="image_gallery md:flex gap-4 px-4 mt-10 md:mt-0 md:space-y-0 space-y-2">
        <div class="img">
            <img class="rounded-lg" src='/images/home/slider_image_01.webp' alt="" />
        </div>
        <div class="img">
      ...
      <div class="content_box bg-rose-50 mt-10 p-10">
        ...
        <div class="tag">
          <ul class="flex flex-wrap gap-4 mt-4">
            <li class="py-2 px-4 rounded-md bg-slate-900 text-white">Atlanta</li>
        ...
        <div class="card mt-10 md:flex justify-between space-y-4 md:space-y-0 gap-4">
          <div class="item bg-white pb-4 md:w-3/12">
            <div class="img">
                <img class="rounded-tl-lg h-60 rounded-tr-lg" src="/images/home/property_image_01.webp" alt="" />
            </div>
            ...
            <div class="flex gap-2">
              <p class="rounded-l-full rounded-br-full bg-blue-700 p-[4px] w-fit text-white">4.4/<span
                  class="text-[12px]">5</span>
              </p>
              <p>115 reviews</p>
            </div>
          ...
          <div class="item bg-white pb-4 md:w-3/12">
            <div class="img">
              <img class="rounded-tl-lg rounded-tr-lg h-60 w-full" src="./images/home/property_image_02.webp" alt="" />
            </div>
            <div class="flex gap-2 mt-2">
              <p>Hilton Atlanta</p>
              <img src="./images/five_star.png" alt="" />
          ...
          <div class="item bg-white pb-4 md:w-3/12">
            <div class="img">
                <img class="rounded-tl-lg h-60 w-full rounded-tr-lg" src='./images/home/property_image_04..webp' alt="" />
            </div>
            <div class="flex gap-2 mt-2">
              <p>Hilton Atlanta</p>
                <img src="./images/five_star.png" alt="" />
          ...
          <div class="item bg-white md:w-3/12 relative overflow-hidden">
              <img class="md:h-full rounded-md" src="/images/home/property_image_03.png" alt="" />
            ...
            <div class="absolute bottom-0 w-full flex justify-center items-center">
              <div class="py-10 px-4">
                <h2 class="text-white text-lg">Discover great deals on hotels around the world</h2>
                <div>
                  <a href="#">
                    <p class="button py-2 text-center rounded-md mt-2 bg-blue-500">Go Now</p>
                  </a>
                </div>
              </div>
            </div>
      ...
      <div class="content_box bg-rose-50 mt-10 p-10">
        ...
        <div class="tag">
          <ul class="flex flex-wrap gap-4 mt-4">
            <li class="py-2 px-4 rounded-md bg-slate-900 text-white">Bangkok</li>
        ...
        <div class="card mt-10 md:flex justify-between space-y-4 md:space-y-0 gap-4">
          <div class="item bg-white pb-4">
            <div class="img">
                <img class="rounded-tl-lg rounded-tr-lg" src="./images/home/beauty_of_place01.webp" alt="" />
            </div>
            <div class="p-4">
              <div class="flex gap-2 mt-2">
                <p>Hilton Atlanta</p>
          ...
          <div class="item bg-white pb-4">
            <div class="img">
                <img class="rounded-tl-lg rounded-tr-lg" src="./images/home/beauty_of_place02.webp" alt="" />
            </div>
            <div class="p-4">
              <div class="flex gap-2 mt-2">
                <p>Hilton Atlanta</p>
          ...
          <div class="item bg-white pb-4">
            <div class="img">
                <img class="rounded-tl-lg rounded-tr-lg" src="/images/home/beauty_of_place03.webp" alt="" />
            </div>
            <div class="p-4">
              <div class="flex gap-2 mt-2">
                <p>Hilton Atlanta</p>
          ...
          <div class="item bg-white relative overflow-hidden bg-blue-500">
              <img class="md:h-full rounded-md" src="/images/home/women_bath.png" alt="" />
            <div class="absolute w-full h-32 bg-sky-500 bottom-0 blur-3xl"></div>
            <div class="absolute bottom-0 w-full flex justify-center items-center">
              <div class="py-10 px-4">
                <h2 class="text-white text-lg">Discover great deals on hotels around the world</h2>
      ...
      <div class="content_box bg-rose-50 mt-10 p-10">
        ...
        <div class="tag">
          <ul class="flex flex-wrap gap-4 mt-4">
            <li class="py-2 px-4 rounded-md bg-slate-900 text-white">Orlando</li>
        ...
        <div class="card mt-10 md:flex justify-between space-y-4 md:space-y-0 gap-4">
          <div class="item md:w-3/12 bg-white pb-4">
            <div class="img">
                <img class="rounded-tl-lg rounded-tr-lg" src="/images/home/car01.png" alt="" />
          ...
          <div class="item bg-white md:w-3/12 pb-4">
            <div class="img">
                <img class="rounded-tl-lg rounded-tr-lg" src="/images/home/car02.png" alt="" />
            </div>
            <div class="flex gap-2 mt-2">
              <p>Hilton Atlanta</p>
              <img src="./images/five_star.png" alt="" />
          ...
          <div class="item md:w-3/12 bg-white relative overflow-hidden">
              <img class="md:h-full rounded-md" src="/images/home/car03.png" alt="" />
            <div class="absolute w-full h-32 bg-sky-500 bottom-0 blur-3xl"></div>
            <div class="absolute bottom-0 w-full flex justify-center items-center">
              <div class="py-10 px-4">
                <h2 class="text-white text-lg">Discover great deals on hotels around the world</h2>
      ...
      <div class="bottom hidden md:block overflow-hidden h-[80vh] bg-[url('/images/home/bg_2.webp')] bg-center bg-no-repeat pt-20">
        <div class="container px-20 flex gap-10">
          <div class="item">
              <img class="w-96 rounded-t-[40px] border-[12px]" src="/images/home/en-us-phone.jpg" alt="" />
          </div>
          <div class="item mt-2">
            <h2 class="text-white text-4xl">Get the Trip.com App</h2>
            <p class="text-white mt-4">Our award-winning app gives you 30% extra Trip Coins.</p>

            <div class="flex items-center">
              <div class="left">
                <div class="mt-4 w-11/12">
                  <div class="flex gap-2 items-center my-4">
                    <div class="btn text-white py-2 px-4 rounded-lg border-2">SMS</div>
                    <div class="btn text-white py-2 px-4">email</div>
                  </div>
                  <p class="text-sm mb-4 text-white">Enter your phone number to receive a text with a link to download
                    the
                    app.</p>
                    <input class="px-2 w-full py-2 text-white" placeholder="Mobile number" type="text" />
                  <div>
                    <a href="#">
                      <p class="button py-2 text-center rounded-md mt-2 bg-blue-500">Go Now</p>
                    </a>
              ...
              <div class="right items-center flex gap-4 w-1/3 ml-10">
                <div class="left">
                    <img class="mb-4" src="/images/home/android-en-us.png" alt="" />
                    <img src="/images/home/ios-en-us.png" alt="" />
                </div>
                <div class="right">
                    <img class="rounded-lg w-32 border-2" src="/images/home/download.png" alt="" />
                </div>
              </div>
            </div>
          </div>
